              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Data Fasilitas Kamar</h4>
                                <div class="basic-form">
                                    ...
                                    <form data-action="{{ route('rekening.store') }}" data-id="" data-type="post" method="POST" id="modal-tambah-data">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="atn" type="text" name="atn" class="form-control" placeholder="User1, User2...">
                                                <div style="display: none" id="val-atn-error" class="invalid-feedback animated fadeInDown" style="display: block;"></div>
                                            </div>
                                        </div>
                                        {{-- <div class="form-group row">
