                    ...
                    <div class="form-input-content">
                        <div class="card login-form mb-0">
                            <div class="card-body pt-5">
                                    ...
                                    <a class="text-center" href="index.html"> <h4 style="color: #1853fe">Pendaftaran Pengelola</h4></a>
        
                                <form class="mt-5 mb-5 login-input" method="POST" action="{{ route('register-pengelola.post') }}">
                                    @csrf 
                                    <div class="form-group">
                                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror"  placeholder="Nama Pengelola" required>
                                    ...
                                    <div class="form-group">
                                        <input type="email" name="email" class="form-control @error('email') is-invalid @enderror"  placeholder="Email Pengelola" required>
                                    ...
                                    <div class="form-group">
                                        <input type="password" name="password" class="form-control" placeholder="Kata Sandi Pengelola" required>
                                        @error('password')
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control" name="alamat" required id="" cols="30" rows="10" placeholder="Alamat Pengelola"></textarea>
                                        @error('alamat')
                                           <div id="val-nik-error" class="invalid-feedback animated fadeInDown" style="display: block;">
                                                {{ $message }}
                                            </div>
