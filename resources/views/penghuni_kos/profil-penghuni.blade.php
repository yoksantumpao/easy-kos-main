                                ...
                                <div class="basic-form">
                                    ...
                                    <form data-action="{{ route('penghuni_kos.store') }}" data-id="" data-type="post" method="POST" id="modal-tambah-data">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Nama Penghuni Kos</label>
                                            <div class="col-sm-10">
                                                <input id="nama_penghuni" type="text" name="nama_penghuni" value="{{ $data->nama_penghuni }}" class="form-control" placeholder="...">
                                                <div style="display: none" id="val-nama_penghuni-error" class="invalid-feedback animated fadeInDown" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Email Penghuni Kos</label>
                                            <div class="col-sm-10">
                                                <input id="email_penghuni" type="text" name="email_penghuni" value="{{ $data->email_penghuni }}" class="form-control" placeholder="...">
                                                <div style="display: none" id="val-email_penghuni-error" class="invalid-feedback animated fadeInDown" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Password Penghuni Kos</label>
                                            <div class="col-sm-10">
                                                <input id="password" type="password" name="password" value="{{ $data->password }}" class="form-control" placeholder="...">
                                                <div style="display: none" id="val-password-error" class="invalid-feedback animated fadeInDown" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    ...
                                                    <select id="jenis_kelamin" name="jenis_kelamin" class="form-control" value={{ $data->jenis_kelamin }} >
                                                        <option value="" selected disabled>Pilih Jenis Kelamin</option>
                                                        <option value="Pria">Pria</option>
                                                        <option value="Wanita">Wanita</option>
                                                    </select>
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Nomor Telephone</label>
                                            <div class="col-sm-10">
                                                <input id="no_telp" type="number" name="no_telp" value="{{ $data->no_telp }}" class="form-control" placeholder="...">
                                                <div style="display: none" id="val-no_telp-error" class="invalid-feedback animated fadeInDown" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Nomor Whatsapp</label>
                                            <div class="col-sm-10">
                                                <input id="no_wa" type="number" name="no_wa" value="{{ $data->no_wa }}" class="form-control" placeholder="...">
                                                <div style="display: none" id="val-no_wa-error" class="invalid-feedback animated fadeInDown" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">Pekerjaan</label>
                                            <div class="col-sm-10">
                                                <input id="pekerjaan" type="text" name="pekerjaan" value="{{ $data->pekerjaan }}" class="form-control" placeholder="...">
                                                <div style="display: none" id="val-pekerjaan-error" class="invalid-feedback animated fadeInDown" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">NIK</label>
                                            <div class="col-sm-10">
                                                <input id="nik" type="number" name="nik" class="form-control" value="{{ $data->nik }}" placeholder="...">
                                                <div style="display: none" id="val-nik-error" class="invalid-feedback animated fadeInDown" style="display: block;"></div>
                                            </div>
                                        </div>
                                        <div class="form-group row">    
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group mb-3">
                                                 <img id="showFoto" src="{{ asset('fotoPenghuniKos/'.$data->ktp) }}" alt="" style="
                                                    width: 100%;
                                                    height: 300px;
                                                    object-fit: contain;
                                                    object-position: bottom;
                                        ...
                                        <div class="form-group row">    
                                            ...
                                            <div class="col-sm-10">
                                                <div class="input-group mb-3">
                                                  <img id="showFoto" src="{{ asset('fotoPenghuniKos/'.$data->foto_profile) }}" alt="" style="
                                                    width: 100%;
                                                    height: 300px;
                                                    object-fit: contain;
                                                    object-position: bottom;
